...
hl.config({
	general = {
		...
		col = {
			active_border = "rgba(80ccffaa)",
			inactive_border = "rgba(80ccff22)",
		},
	...
	group = {
		col = {
			border_active = "rgba(80ccffaa)",
			border_inactive = "rgba(80ccff22)",
		},
		groupbar = {
			font_size = 12,
			font_weight_active = "bold",
			col = {
				active = "rgba(80ccffaa)",
				inactive = "rgba(80ccff22)",
			},
		},
	},
})
...
hl.bind(mainMod .. " + M", hl.dsp.global("quickshell:logout"))
...
hl.bind(mainMod .. " + T", hl.dsp.window.tag({ tag = "alpha" }))
...
hl.bind("Print", hl.dsp.exec_cmd('grim && notify-send "Screenshot" "Saving to Pictures folder..."'))
...
hl.window_rule({ opacity = 0.8, match = { tag = "alpha" } })

require("customwindows")
